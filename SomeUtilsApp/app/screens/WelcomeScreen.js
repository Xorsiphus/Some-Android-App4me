    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.buttonsView}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.5}
          style={styles.oneButtonView}
        >
          <Text style={styles.oneButtonText}>Арты</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => props.navigation.navigate("ISSPositionScreen")}
          activeOpacity={0.5}
          style={styles.oneButtonView}
        >
        ...
        <TouchableOpacity
          onPress={() => props.navigation.navigate("ChooseIngredientsScreen")}
          activeOpacity={0.5}
          style={styles.oneButtonView}
        >
      ...
      <View style={styles.infoView}>
        ...
        <Text style={styles.infoText}>v0.9 alfa</Text>
      </View>
    </SafeAreaView>
  );
}
