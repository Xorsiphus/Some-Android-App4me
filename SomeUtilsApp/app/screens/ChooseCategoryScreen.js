...
import { LogBox, StyleSheet, SafeAreaView, FlatList, View, Text, ScrollView, Button, TouchableOpacity, TouchableWithoutFeedback } from 'react-native'
                    ...
                    <View style={styles.scrollView}>
                        <FlatList
                            ...
                            <View style={styles.button}>
                                <Button color='coral' title={item.name} onPress={() => props.navigation.navigate('ShowImages', {categoryName: item.name, link: apiLink})}/>
                            </View>)} 
                        />
                    </View>
                </View>
